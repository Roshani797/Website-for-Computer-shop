...
// Get cart count
$cartCountResult = $conn->query("SELECT SUM(quantity) AS total FROM cart WHERE session_id = '$session_id'");
$cartCountRow = $cartCountResult ? $cartCountResult->fetch_assoc() : ['total' => 0];
$cart_count = $cartCountRow['total'] ?? 0;
...
// Peripheral products
$peripherals = [
    ['id' => 30000, 'name' => 'Logitech Wireless Mouse', 'price' => 2500, 'image' => 'image/peripheral1.png'],
    ['id' => 30001, 'name' => 'Dell Wired Keyboard', 'price' => 3000, 'image' => 'image/peripheral2.png'],
    ['id' => 30002, 'name' => 'HP USB Webcam', 'price' => 6200, 'image' => 'image/peripheral3.png'],
    ['id' => 30003, 'name' => 'Sandisk 64GB USB 3.0', 'price' => 1800, 'image' => 'image/peripheral4.png'],
    ['id' => 30004, 'name' => 'TP-Link WiFi Adapter', 'price' => 2200, 'image' => 'image/peripheral5.png'],
];
$slideshow_peripherals = [
    ['id' => 30005, 'name' => 'Wireless Headset', 'price' => 4500, 'image' => 'image/peripheral6.png'],
    ['id' => 30006, 'name' => 'USB-C Hub', 'price' => 3500, 'image' => 'image/peripheral7.png'],
    ['id' => 30007, 'name' => 'Gaming Mouse Pad', 'price' => 1200, 'image' => 'image/peripheral8.png'],
    ['id' => 30008, 'name' => 'Bluetooth Speaker', 'price' => 3800, 'image' => 'image/peripheral9.png'],
    ['id' => 30009, 'name' => 'External HDD 1TB', 'price' => 11000, 'image' => 'image/peripheral10.png'],

];

// Merge with existing
$peripherals = array_merge($peripherals, $slideshow_peripherals);

// Insert into `peripheral` table if not exists
...
<body>
  ...
  <div class="top-header">
    ...
    <div class="nav-right">
      ...
      <a href="our-showroom.php">Bank Details</a>
    ...
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            ...
            <div class='product-card'>
              <a href='product$id.php'><img src='$image' alt='$name'></a>
              <h3>$name</h3>
              <p>Rs. $price</p>
              <div class='product-icons'>
                ...
                <button class='add-to-wishlist-btn'
                  ...
                  data-product-image='$image'>❤</button>
                <a href='buy-now.php?id=$id' class='buy-now-btn'>Buy Now</a>
              </div>
            </div>
            ";
        }
    } else {
        echo "<p style='text-align:center;'>No peripherals found.</p>";
    }
    ?>
  </div>
</section>
<!-- ========== Slideshow Section for New Peripherals ========== -->
<div class="slideshow-container" style="max-width:1200px; margin:auto; overflow:hidden; position:relative;">
  <div class="slideshow-wrapper" style="display:flex; transition: transform 0.5s ease;" id="slideshowWrapper">
    <?php foreach ($slideshow_peripherals as $product): ?>
      <div class="slide" style="flex: 0 0 100%; text-align:center; padding:20px;">
        <a href="product<?= $product['id'] ?>.php">
          <img src="<?= htmlspecialchars($product['image']) ?>" alt="<?= htmlspecialchars($product['name']) ?>" style="width:300px; height:200px; object-fit:contain;">
        </a>
  ...
  <button onclick="plusSlides(-1)" style="position:absolute; top:50%; left:10px; transform:translateY(-50%); font-size:24px;">❮</button>
  <button onclick="plusSlides(1)" style="position:absolute; top:50%; right:10px; transform:translateY(-50%); font-size:24px;">❯</button>
</div>
