...
<head>
  ...
  <style>
    .wishlist-item { border: 1px solid #ccc; margin: 10px; padding: 10px; display: flex; align-items: center; }
    .wishlist-item img { width: 100px; margin-right: 20px; }
  </style>
...
<?php while ($row = $result->fetch_assoc()): ?>
  <div class="wishlist-item" id="item-<?= $row['product_id'] ?>">
